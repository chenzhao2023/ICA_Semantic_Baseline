        ...
        for epoch in tqdm(range(self.params.epoch)):
            ...
            for mini_batch in range(len(self.train_samples)):
                ...
                try:
                    ...
                    # print("[!] cannot convert graph to tree")
                    continue
...
if __name__ == '__main__':
    ...
    # data
    parser.add_argument('--data_file_path', type=str, default="/media/z/data2/artery_semantic_segmentation/pytorch-tree-lstm/data_aaai")
    parser.add_argument('--cv', type=int, default=0)
    parser.add_argument('--cv_max', type=int, default=5)
    
    # model
    parser.add_argument('--model', type=str, default="bi", choices=["bi", "utd", "dtu"])
