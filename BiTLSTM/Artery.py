...
ARTERY_CATEGORY = ["LAO", "RAO"]
                # /media/z/data2/artery_semantic_segmentation/pytorch-tree-lstm/
DATA_FILE_PATH = "/media/z/data21/artery_semantic_segmentation/pytorch-tree-lstm/data"
...
def _load_graph_in_mem(data_file_path, sample_id, dataset=None):
    if dataset is None:
        ...
        return dataset[sample_id]['image'], dataset[sample_id]['binary_image'], dataset[sample_id]['tree']
