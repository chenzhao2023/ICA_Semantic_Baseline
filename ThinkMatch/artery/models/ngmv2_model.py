...
class Net(CNN):
    ...
    def forward(self,data_dict,):
        ...
        for image, p, n_p, graph in zip(images, points, n_points, graphs):
            ...
            # arrange features
            U = concat_features(feature_align(nodes, p, n_p, self.rescale), n_p) # batch*n_node*512
            F = concat_features(feature_align(edges, p, n_p, self.rescale), n_p) # batch*n_node*512
        ...
        if cfg.PROBLEM.TYPE == '2GM':
            ...
            data_dict.update({'ds_mat_list': mgm_s_list, 'perm_mat_list': mgm_x_list, 'graph_indices': indices,})
