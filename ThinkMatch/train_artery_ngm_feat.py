...
if __name__ == '__main__':
    ...
    parser.add_argument('--cache_path', type=str, default='/media/z/data2/artery_semantic_segmentation/ThinkMatch/cache/ngm')
    ...
    # exp
    parser.add_argument('--exp', type=str, default="exp/ngm/CV0")
