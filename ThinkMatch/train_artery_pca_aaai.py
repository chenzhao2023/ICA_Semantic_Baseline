...
class PCA_Model_Trainer(object):
    ...
    def __init_dataset__(self):
        ...
        # split dataset
        training_samples, template_samples = split_dataset_category(f"{self.params.data_path}/view_angles.csv", 
                                                                            self.params.template_ratio, self.params.seed)
...
if __name__ == '__main__':
    ...
    # exp
    parser.add_argument('--exp', type=str, default="exp_aaai/pca/CV0")
