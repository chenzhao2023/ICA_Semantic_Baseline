...
class Model_Trainer(object):
    ...
    def __init_model__(self):
        feat_emb_params = {"POS_FEAT_DIM": 121, "POS_FEAT_HIDDEN": 256, "EMB_DIM": 512, 'N_LAYERS': 3}
        ...
        gnn_params = {"GNN_FEAT": [16, 16], "GNN_LAYER": 2}

        train_params = {"MOMENTUM": 0.9, "OPTIMIZER": "sgd", "EPOCH_ITERS": 2000,
                        "LR_DECAY": 0.1, "LR_STEP": [2, 6, 10], 'LR': 1.0e-3,
                        "LOSS_FUNC": "ce"}
        ...
        #self.model = GMN_Net(ngm_params, gnn_params, feat_emb_params).to(self.device)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default="/media/z/data21/artery_semantic_segmentation/ThinkMatch/artery/data2")
